...
/// the six regions, each zone's states, Kerala's districts, Thiruvananthapuram's
/// assembly segments, their LSGDs and wards ([agentSlotLabelsUnder], loaded
/// from `app.agent_geo_node` with a bundled fallback) — exists as an open slot
/// on "My Team" rather than as a name; registering someone into one is what
/// turns a slot into an agent, and [AgentService] is where that happens.
///
