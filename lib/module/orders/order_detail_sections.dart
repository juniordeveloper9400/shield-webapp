...
///
/// This is the store's own picture of the bill. The itemised invoice (items,
/// prices, totals) is a separate document, drawn by `InvoiceView` on the bill
/// screen this card leads to. The card is not there to show until an admin
/// sends a picture and [ensureBillLoaded] has fetched it, so it renders
/// nothing at all rather than a card with an empty middle.
